...
const render = () => {
	const [ partialPaymentAmount, setPartialPaymentAmount ] =
		settings.partial_payment_amount
			? useState( settings.partial_payment_amount )
			: useState( '' );
	...
	return (
		<ExperimentalDiscountsMeta>
			{ settings.active ? (
				...
				>
					<div className="wc-block-components-partial-payment">
						<form
							...
							<ValidatedTextInput
								...
								validate={ ( value ) => {
									...
									if (
										...
										return __(
											'Amount cannot exceed the order total payable from your wallet',
											'woo-wallet'
										);
									}
								} }
