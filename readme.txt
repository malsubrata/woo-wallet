...
– **New:-** An optional email sign-up for TeraWallet setup tips on the Wallet Dashboard and Upgrade to Pro screens. It is opt-in only: the consent box starts unchecked, the address field starts empty and is never pre-filled from your WordPress account, and nothing is transmitted anywhere unless you enter an address, tick consent and submit. Dismissing it sends nothing. It is not an admin notice and appears on TeraWallet screens only.
